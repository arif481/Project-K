        ...
        >
            ...
            >
                <HudCard
                    ...
                    className="w-full max-w-lg border-[var(--neon-magenta)] shadow-[0_0_40px_rgba(255,0,60,0.15)]"
                >
                    <div className="space-y-6">

                        {/* Header */}
                        <p className="text-xs text-[var(--text-secondary)] font-mono border-b border-[var(--border-dim)] pb-3">
                        ...
                        <div className="space-y-4">
                            <div className="text-[10px] uppercase font-mono text-[var(--neon-cyan)] tracking-widest">
                            ...
                            {substances.map(sub => {
                                ...
                                return (
                                    <div
                                        key={sub}
                                        className={`p-3 rounded border ${isActive ? 'border-[var(--neon-green)] bg-[var(--bg-grid)]' : 'border-[var(--border-dim)]'}`}
                                    >
                                        <div className="flex items-center justify-between mb-2">
                                            ...
                                            <div className={`text-[10px] px-2 py-0.5 rounded ${isActive ? 'bg-[var(--neon-green)] text-black' : 'bg-[var(--border-dim)] text-[var(--text-secondary)]'}`}>
                                                {isActive ? 'ACTIVE' : 'INACTIVE'}
                                            </div>
                                        </div>

                                        <div className="flex flex-col gap-1">
                                            <label className="text-[10px] font-mono text-[var(--text-secondary)]">
                                                {config.costLabel}
                                            </label>
                                            <div className="flex items-center gap-2">
                                                ...
                                                <input
                                                    ...
                                                    className="flex-1 bg-black border border-[var(--border-dim)] p-2 text-white font-mono focus:border-[var(--neon-cyan)] outline-none transition-colors"
                                                />
                                            </div>
                                        ...
                                        {isActive && (
                                            <div className="mt-2 pt-2 border-t border-[var(--border-dim)]">
                                                <div className="flex justify-between text-[10px] font-mono">
                                                    <span className="text-[var(--text-secondary)]">Protocol Started:</span>
                                                    <span className="text-[var(--neon-cyan)]">{formatDate(quitDates[sub])}</span>
                                                </div>
                                            </div>
                                        )}
                                    </div>
                        ...
                        {/* Help Text */}
                        <div className="text-[10px] text-[var(--text-secondary)] font-mono bg-[var(--bg-grid)] p-3 rounded border border-[var(--border-dim)]">
                            <div className="text-[var(--neon-yellow)] mb-1">💡 TIP</div>
                        ...
                        {/* Actions */}
                        <div className="flex justify-end gap-3 pt-4 border-t border-[var(--border-dim)]">
